...
gamma_I <- 2  # grazing rate of infected first int hosts, 
gamma_U <- 2  # grazing rate of uninfected first int hosts
...
r_SU <- 1 # reproduction of new uninfected second intermediate hosts
r_SI <- 1 # reproduction of new uninfecteds by INFECTED second intermediate hosts
